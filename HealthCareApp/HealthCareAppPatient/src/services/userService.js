...
const getTopDoctorHomeService = async (by) => {
    return await axios.get(`/api/top-doctor-home?by=${by}`)
}
...
const getAllSpecialty = async (by) => {
    return await axios.get(`/api/get-all-specialty?by=${by}`)
}
...
const getAllClinic = async (by) => {
    return await axios.get(`/api/get-all-clinic?by=${by}`)
}
...
const getAllPatientForDoctor = (data) => {
    return axios.get(`/api/get-list-patient-for-doctor?doctorId=${data.doctorId}&date=${data.date}&status=${data.status}`)
}
